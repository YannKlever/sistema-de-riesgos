...
export const ModalMitigacion = ({
    ...
    const handleGuardar = async () => {
        try {
            ...
            const resultado = await databaseService.actualizarAccionistaSocio(accionistaId, datosActualizacion);

            if (resultado.success) {
                // Pasar los datos actualizados al callback
                const accionistaActualizado = {
                    id: accionistaId,
                    ...datosActualizacion
                };

                if (onMitigacionGuardada) {
                    onMitigacionGuardada(accionistaActualizado);
                }
                onClose();
            } else {
