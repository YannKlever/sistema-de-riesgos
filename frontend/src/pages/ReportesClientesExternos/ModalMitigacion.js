...
export const ModalMitigacion = ({ 
    ...
    const handleGuardar = async () => {
        try {
            ...
            const resultado = await databaseService.actualizarClienteExterno(clienteId, datosActualizacion);
            
            if (resultado.success) {
                if (onMitigacionGuardada) {
                    // Pasar el cliente actualizado al callback
                    onMitigacionGuardada({
                        id: clienteId,
                        ...datosActualizacion
                    });
            ...
            <div className={styles.modalContent}>
                ...
                <div className={styles.modalBody}>
                    ...
                    <div className={styles.checklistContainer}>
                        <h3>Seleccione las medidas de mitigación aplicables (opcional):</h3>
                    ...
                    <div className={styles.porcentajeContainer}>
                        ...
                        <p className={styles.nota}>
                            {opcionesSeleccionadas.length === 0 
                                ? 'No se han seleccionado medidas de mitigación' 
                                : `${opcionesSeleccionadas.length} medida(s) seleccionada(s)`}
                        </p>
                    </div>
